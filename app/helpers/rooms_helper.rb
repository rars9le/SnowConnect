module RoomsHelper
  ...
  def most_new_message_date_preview(room)
    ...
    # メッセージがあれば内容を表示
    tag.span message.updated_at.to_s(:datetime_jp).to_s
  end
end
